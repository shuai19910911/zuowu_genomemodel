...
|最新公开里程碑|step40000 / 50000（80%）|
|最新验证点|step40000|
|当前最佳验证点|step40000|
|best val selection loss|0.9951305|
...
从正式候选起点step16000到step40000，validation selection loss由1.0406386降至0.9951305，下降0.0455081（约4.37%）。总体趋势继续改善，但total loss和辅助region指标并非每个点都严格单调，最终模型价值仍必须由固定下游任务验证。
