...
2026-08-07 19:30 CST快照：93/1572行、8/251个GPU组闭合，终止失败0。CPU-only下游任务在gpu05本机CPU执行：调度daemon运行中，1个worker活跃、52行就绪，全部隐藏CUDA设备、按内存限流；SLURM q05提交已禁用且q05无本项目作业。gpu05新GPU派发保持暂停。
